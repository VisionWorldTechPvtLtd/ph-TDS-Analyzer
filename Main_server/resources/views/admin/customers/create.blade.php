    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- <h5 class="card-title">Register Customer <span>| new</span></h5> -->
                        <br>
                        ...
                        <form class="row g-3" method="POST" action="{{ route('customers.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="test" class="form-control" id="contact_no" name="contact_no" max="{{ date('Y-m-d') }}" value="{{ old('contact_no') }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="test" class="form-control" id="company" name="company" max="{{ date('Y-m-d') }}" value="{{ old('company') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <input type="checkbox" class="mx-4" id="status" name="status" placeholder="">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="test" class="form-control" id="user_flow_limit" name="user_flow_limit" placeholder="">
                ...
                <div class="col-md-3">
                    <div class="mb-3 form-floating">
                        <select class="form-select" id="roles" name="roles_id">
                            ...
                            <option value="{{ $role->id }}" {{ old('roles_id', $customer->roles_id ?? '') == $role->id ? 'selected' : '' }}>
                                {{ $role->roles }}
                            </option>
                            @endforeach
                        </select>
