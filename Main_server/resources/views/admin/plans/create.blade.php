        ...
        <section class="section dashboard">
          <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Register Plan <span>| new</span></h5>
                        <hr>
                        <!-- Floating Labels Form -->
                        <form class="row g-3" method="POST" action="{{ route('plans.store') }}">
                            @csrf
                            <div class="col-md-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="description" placeholder="description.." id="description" style="height: 70px;">{{ old('description') }}</textarea>
