        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> Nothing <span>| all</span></h5>
                            ...
                            <table class="table table-borderless datatable" id="report">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-light bg-danger">{{ date('M d Y', strtotime($pump->created_at)) }}</td>
                                        <td class="action">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("exportBtn").addEventListener("click", function() {
            exportTableToExcel('report', 'Nothing_Report.xlsx');
        });
    });
