                ...
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" action="{{route('storeHWRA')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mt-2 form-group">
                                    <input type="text" name="abstructionstructurenumber" class="mt-3 form-control" id="abstructionstructurenumber" placeholder="Abstruction Structure Number" />
                                </div>
                                <div class="mt-2 form-group">
                                ...
                                <div class="mt-2 form-group">
                                    <select name="sensor" class="mt-3 form-control" id="sensor" required>
                                        <option value="" disabled selected>Select Sensor</option>
                                        <option value="1">Piezometer</option>
                                        <option value="2">Flowmeter</option>
                                    </select>
                                    @error('sensor')
