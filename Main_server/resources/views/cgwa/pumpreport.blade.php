            ...
            <div class="mb-4 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('cgwa.pumpdata') }}">
                            @csrf
                            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title d-flex justify-content-between align-items-center">
                            ...
                            <button id="exportExcelBtn" class="btn btn-dark" style="margin-left:834px;"> Excel</button>

                            @if(session('report_data') && session('report_data')->isNotEmpty())
                            @php
                            $firstData = session('report_data')->first();
                            @endphp

                            @if(isset($firstData->pdfd_id))
                            <a href="{{ route('cgwa.data.edit', $firstData->pdfd_id) }}" class="btn btn-dark btn-sm">
