...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="container-fluid px-0">
            <div class="mb-4 site-banner d-flex align-items-center justify-content-center" style="height:650px; width: 100%; background: url('{{ asset('assets/img/analyzer.png') }}') center center / cover no-repeat;
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-md-6">
                <div class="p-4 card h-100 shadow-lg border-0" style="background: linear-gradient(to right, #f8f9fa, #e3f2fd); border-radius: 12px;">
                    ...
                    <div class="mb-3 d-flex align-items-center text-dark">
                        ...
                        <span class="fw-medium">+91-7742714000</span>
                    </div>
                    ...
                    <div class="d-flex align-items-start text-dark">
                        ...
                        <span class="fw-medium">
                            A-15 Jai Ambey Nagar in front of Jaipur Hospital,<br>
            ...
            <!-- Contact Form Column -->
            <div class="col-12 col-md-6">
                <div class="p-4 card h-100 shadow-lg border-0" style="background: linear-gradient(135deg, #f9f7fe 0%, #d0e8f2 100%); border-radius: 12px;">
